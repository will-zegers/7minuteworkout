    ...
    function($scope, $interval, $location) {
      ...
      let WorkoutPlan = function(args) {
        ...
        this.totalWorkoutDuration = () => {
          ...
          let total = 0;
          angular.forEach(this.exercises, exercise => {
      ...
      let startExercise = exercisePlan => {
        ...
        $interval(() => {
          ...
          .then(() => {
            let next = getNextExercise(exercisePlan);
            if (next) {
              startExercise(next);
            } else {
      ...
      let getNextExercise = currentExercisePlan => {
